...
const AddStudent = () => {
    ...
    useEffect(() => {
        const getSchools = async () => {
            const request = await fetch('https://tsc-server.onrender.com/schools');
    ...
    useEffect(() => {
        const getClasses = async () => {
            const request = await fetch('https://tsc-server.onrender.com/classes');
            const response = await request.json();
            setClasses(response);
        };
        getClasses();
    ...
    useEffect(() => {
        const getDivisions = async () => {
            const request = await fetch('https://tsc-server.onrender.com/divisions');
            const response = await request.json();
    ...
    const onSubmit = async (data, e) => {
        ...
        // Add a new student
        const url = `https://tsc-server.onrender.com/student`;
